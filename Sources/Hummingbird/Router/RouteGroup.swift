...
public struct RouteGroup<Context: HBRequestContext, Handler: MiddlewareProtocol>: HBMiddlewareProtocol where Handler.Input == HBRequest, Handler.Output == HBResponse, Handler.Context == Context {
    ...
    public init(
        ...
        @MiddlewareBuilder<HBRequest, HBResponse, Context> builder: () -> Handler
    ) {
